...
makeplrbutton("kill").MouseButton1Click:Connect(function()
	NotificationLibrary:SendNotification("Success", "killed the target", 5)
	fekill(currentplayer.Character)
end)

makeplrbutton("attach").MouseButton1Click:Connect(function()
	NotificationLibrary:SendNotification("Success", "glued", 5)
...
makeplrbutton("view friends").MouseButton1Click:Connect(function()
	NotificationLibrary:SendNotification("Success", "now viewing a loner's friends", 5)
		...
		if c and c.Parent then
			...
			if part then
				...
				if c1 and c1.Parent then
					...
					NotificationLibrary:SendNotification("Error", "target part not found", 5)
					end
				else
					NotificationLibrary:SendNotification("Error", "target char not found", 5)
				end
			else
					NotificationLibrary:SendNotification("Error", "part not found", 5)
			end
		else
					NotificationLibrary:SendNotification("Error", "char not found", 5)
		end
	end)
end
...
makegraphicsbutton("remove fog").MouseButton1Click:Connect(function()
	NotificationLibrary:SendNotification("Success", "removed fog", 5)
	lig.FogStart = 9e9
	lig.FogEnd = 9e9
end)
...
addpositionbutton.MouseButton1Click:Connect(function()
	NotificationLibrary:SendNotification("Success", "saved position", 5)
	local c = lp.Character
	if c and c.Parent then
		...
		if hrp then
			...
			loadposbutton.MouseButton1Click:Connect(function()
				NotificationLibrary:SendNotification("Success", "loaded position", 5)
				c = lp.Character
				if c and c.Parent then
...
makecharbutton("respawn").MouseButton1Click:Connect(function()
	NotificationLibrary:SendNotification("Success", "respawning after message leaves", 5)
	if not loopr then
		reset(true)
		twait()
	end
...
makecharbutton("reset").MouseButton1Click:Connect(function()
		NotificationLibrary:SendNotification("Success", "success", 5)
	reset(false)
end)
...
looprb.MouseButton1Click:Connect(function()
	NotificationLibrary:SendNotification("Success", "loop respawn activated/deactivated", 5)
	loopr = not loopr
...
makecharbutton("remove meshes").MouseButton1Click:Connect(function()
	...
	if c and c.Parent then
		...
		NotificationLibrary:SendNotification("Success", "removed meshes", 5)
	else
		NotificationLibrary:SendNotification("Error", "no char found", 5)
	end
end)
makecharbutton("remove accessories").MouseButton1Click:Connect(function()
	NotificationLibrary:SendNotification("Success", "Removed accessories!", 5)
    removehats()
end)
makecharbutton("break joints").MouseButton1Click:Connect(function()
	...
	if c and c.Parent then
		c:BreakJoints()
		NotificationLibrary:SendNotification("Success", "broken joints", 5)
	else
		NotificationLibrary:SendNotification("Error", "no char found", 5)
	end
end)
...
noclipb.MouseButton1Click:Connect(function()
	NotificationLibrary:SendNotification("Success", "noclip activated/deactivated", 5)
	noclip = not noclip
...
fakevoidb.MouseButton1Click:Connect(function()
	if fakevoidp then
		...
		NotificationLibrary:SendNotification("Success", "sent to space", 5)
		...
		if c and c.Parent then
			...
			if part and part.Parent then
				...
				NotificationLibrary:SendNotification("Success", "Sent to original spot", 5)
			else
				NotificationLibrary:SendNotification("Error", "no char found", 5)
			end
		else
...
makecharbutton("block tool").MouseButton1Click:Connect(function()
	...
	if c and c.Parent then
		...
		if tool then
			...
			if found then
			NotificationLibrary:SendNotification("Success", "removed tool meshes", 5)
			else
			NotificationLibrary:SendNotification("Success", "removed tool meshes", 5)
			end
		else
			NotificationLibrary:SendNotification("Error", "equip a tool dumbass??", 5)
		end
	else
	NotificationLibrary:SendNotification("Error", "no char found", 5)
	end
...
infjumpb.MouseButton1Click:Connect(function()
	NotificationLibrary:SendNotification("Success", "inf jump activated/deactivated", 5)
	infjump = not infjump
	infjumpb.Text = "infjump" .. ((infjump and " (Enabled)") or "")
end)
local flyb = makecharbutton("fly")
flyb.MouseButton1Click:Connect(function()
	NotificationLibrary:SendNotification("Success", "fly activated/deactivated", 5)
	if cfly and cfly.Parent then
		cfly = nil
	else
	    if fakevoidp then
...
hiddenflingB.MouseButton1Click:Connect(function()
	NotificationLibrary:SendNotification("Success", "hidden fling activated/deactivated", 5)
...
NotificationLibrary:SendNotification("Success", "now sitting", 5)
	...
	if c and c.Parent then
		...
		NotificationLibrary:SendNotification("Error", "no humanoid found", 5)
		end
	else
		NotificationLibrary:SendNotification("Error", "no char found", 5)
	end
...
makecharbutton("fake sit").MouseButton1Click:Connect(function()
	...
	if c and c.Parent then
		...
		if hum then
			...
			hum.Sit = true
		NotificationLibrary:SendNotification("Success", "humanoid.sit.value == true", 5)
		else
		NotificationLibrary:SendNotification("Error", "no humanoid found", 5)
		end
	else
	...
	if c then
		...
		if cpar then
			...
			if hrp then
				...
				hrp:Destroy()
				c.Parent = cpar
			NotificationLibrary:SendNotification("Warning", "u gon get banned for this", 5)
			else
			NotificationLibrary:SendNotification("Error", "no hrp found", 5)
			end
		else
			NotificationLibrary:SendNotification("Error", "no char found", 5)
		end
...
makecharbutton("set CanTouch to false").MouseButton1Click:Connect(function()
	...
	NotificationLibrary:SendNotification("Success", "cantouch.value == false", 5)
	else
	NotificationLibrary:SendNotification("Error", "no char found", 5)
	end
end)
...
clicktpbutton.MouseButton1Click:Connect(function()
	NotificationLibrary:SendNotification("Success", "click teleport activated/deactivated", 5)
	ctrltp = not ctrltp
...
espb.MouseButton1Click:Connect(function()
	NotificationLibrary:SendNotification("Success", "now u can see idiots", 5)
	esp = not esp
...
teamcheckb.MouseButton1Click:Connect(function()
	NotificationLibrary:SendNotification("Success", "idk what this does lmfao", 5)
...
antiattb.MouseButton1Click:Connect(function()
	NotificationLibrary:SendNotification("Success", "now losers won't try to kill you", 5)
	antiatt = not antiatt
...
netb.MouseButton1Click:Connect(function()
	NotificationLibrary:SendNotification("Success", "no idea what the fuck this does", 5)
	if net then
		net = false
	elseif shp then
	    net = true
...
makeutilbutton("rejoin").MouseButton1Click:Connect(function()
	NotificationLibrary:SendNotification("Success", "rejoining", 5)
